#!/usr/bin/env python3
"""Tests for extract_mp4_frames tool."""
...
EXTRACT_MP4_FRAMES = os.path.join(TOOLS_DIR, "extract_mp4_frames.py")
...
def test_basic_extraction():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        assert result.returncode == 0, f"extract_mp4_frames failed: {result.stderr}"
...
def test_loop_basic():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        assert result.returncode == 0, f"extract_mp4_frames --loop failed: {result.stderr}"
